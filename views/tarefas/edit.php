...
<form method="POST" action="/tarefas/update" class="standard-form" id="edit-form">
    ...
    <textarea id="description" name="descricao" type="text" placeholder="Altere sua tarefa..." class="form-control" style="height: 100px;" required="required" minlength="3" maxlength="100"><?= $_POST['description_update']?></textarea>
